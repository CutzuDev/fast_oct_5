...
export default function Footer() {
  ...
  return (
    <footer className="flex py-20 min-h-80 w-full flex-col items-center justify-center gap-10">
      ...
      <div className="flex flex-wrap items-center justify-center gap-8">
        {list.map((e, i) => {
          return (
            <div className="relative aspect-square w-8 rounded-md border border-neutral-800/10 bg-white">
